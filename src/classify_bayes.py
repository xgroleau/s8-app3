...
RELOAD_PARAMS = False
if RELOAD_PARAMS:
    params = param_nd(categorized_collection, [(extractor_unique, {'dimension': 0, 'base_function': rgb_to_cmyk}),
                                               (extractor_unique, {'dimension': 1, 'base_function': rgb_to_cmyk}),
                                               (extractor_unique, {'dimension': 2, 'base_function': rgb_to_cmyk}),
                                               (extractor_unique, {'dimension': 3, 'base_function': rgb_to_cmyk}),
                                               (extractor_mean, {'dimension': 0, 'base_function': rgb_to_cmyk}),
                                               ...
                                               (extractor_median, {'dimension': 0, 'base_function': rgb_to_cmyk}),
                                               (extractor_median, {'dimension': 1, 'base_function': rgb_to_cmyk}),
                                               (extractor_median, {'dimension': 2, 'base_function': rgb_to_cmyk}),
                                               (extractor_median, {'dimension': 3, 'base_function': rgb_to_cmyk}),
                                               (extractor_std, {'dimension': 0, 'base_function': rgb_to_cmyk}),
                                               (extractor_std, {'dimension': 1, 'base_function': rgb_to_cmyk}),
                                               (extractor_std, {'dimension': 2, 'base_function': rgb_to_cmyk}),
                                               (extractor_std, {'dimension': 3, 'base_function': rgb_to_cmyk})], num_images=-1)
...
# Keep extractor_unique, rgb mean, rgb median peut remove median et unique xyz
# params = param_remove_unused(params, [0,1,2,6,7,8])
